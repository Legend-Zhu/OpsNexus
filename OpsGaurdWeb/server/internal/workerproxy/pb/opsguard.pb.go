...
var file_opsguard_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_opsguard_proto_goTypes = []any{
	...
	(*ContainerActionRequest)(nil), // 22: opsguard.v1.ContainerActionRequest
	(*ContainerActionResult)(nil),  // 23: opsguard.v1.ContainerActionResult
	(*ProcessesResponse)(nil),      // 24: opsguard.v1.ProcessesResponse
	(*ProcessInfo)(nil),            // 25: opsguard.v1.ProcessInfo
	(*CheckPortRequest)(nil),       // 26: opsguard.v1.CheckPortRequest
	(*PortCheckResult)(nil),        // 27: opsguard.v1.PortCheckResult
	(*CheckHTTPRequest)(nil),       // 28: opsguard.v1.CheckHTTPRequest
	(*HTTPCheckResult)(nil),        // 29: opsguard.v1.HTTPCheckResult
	(*CheckFlowRequest)(nil),       // 30: opsguard.v1.CheckFlowRequest
	(*FlowStep)(nil),               // 31: opsguard.v1.FlowStep
	(*FlowCheckResult)(nil),        // 32: opsguard.v1.FlowCheckResult
	(*FlowStepResult)(nil),         // 33: opsguard.v1.FlowStepResult
	(*ListEventsRequest)(nil),      // 34: opsguard.v1.ListEventsRequest
	(*ListEventsResponse)(nil),     // 35: opsguard.v1.ListEventsResponse
	(*ListAuditRequest)(nil),       // 36: opsguard.v1.ListAuditRequest
	(*ListAuditResponse)(nil),      // 37: opsguard.v1.ListAuditResponse
	(*StreamLogsRequest)(nil),      // 38: opsguard.v1.StreamLogsRequest
	(*LogLine)(nil),                // 39: opsguard.v1.LogLine
	(*SubscribeRequest)(nil),       // 40: opsguard.v1.SubscribeRequest
	(*MonitorEvent)(nil),           // 41: opsguard.v1.MonitorEvent
	(*AuditEntry)(nil),             // 42: opsguard.v1.AuditEntry
	(*TunnelFrame)(nil),            // 43: opsguard.v1.TunnelFrame
	(*TunnelHeader)(nil),           // 44: opsguard.v1.TunnelHeader
	nil,                            // 45: opsguard.v1.CheckHTTPRequest.HeadersEntry
	nil,                            // 46: opsguard.v1.CheckFlowRequest.VarsEntry
	nil,                            // 47: opsguard.v1.FlowStep.HeadersEntry
	nil,                            // 48: opsguard.v1.FlowStep.ExtractEntry
...
var file_opsguard_proto_depIdxs = []int32{
	...
	25, // 3: opsguard.v1.ProcessesResponse.processes:type_name -> opsguard.v1.ProcessInfo
	45, // 4: opsguard.v1.CheckHTTPRequest.headers:type_name -> opsguard.v1.CheckHTTPRequest.HeadersEntry
	31, // 5: opsguard.v1.CheckFlowRequest.steps:type_name -> opsguard.v1.FlowStep
	46, // 6: opsguard.v1.CheckFlowRequest.vars:type_name -> opsguard.v1.CheckFlowRequest.VarsEntry
	47, // 7: opsguard.v1.FlowStep.headers:type_name -> opsguard.v1.FlowStep.HeadersEntry
	48, // 8: opsguard.v1.FlowStep.extract:type_name -> opsguard.v1.FlowStep.ExtractEntry
	33, // 9: opsguard.v1.FlowCheckResult.steps:type_name -> opsguard.v1.FlowStepResult
	49, // 10: opsguard.v1.MonitorEvent.ts:type_name -> google.protobuf.Timestamp
	49, // 11: opsguard.v1.AuditEntry.ts:type_name -> google.protobuf.Timestamp
	44, // 12: opsguard.v1.TunnelFrame.headers:type_name -> opsguard.v1.TunnelHeader
	...
	22, // 27: opsguard.v1.ManagementService.RestartContainer:input_type -> opsguard.v1.ContainerActionRequest
	26, // 28: opsguard.v1.ManagementService.CheckPort:input_type -> opsguard.v1.CheckPortRequest
	28, // 29: opsguard.v1.ManagementService.CheckHTTP:input_type -> opsguard.v1.CheckHTTPRequest
	30, // 30: opsguard.v1.ManagementService.CheckFlow:input_type -> opsguard.v1.CheckFlowRequest
	34, // 31: opsguard.v1.ManagementService.ListEvents:input_type -> opsguard.v1.ListEventsRequest
	36, // 32: opsguard.v1.ManagementService.ListAudit:input_type -> opsguard.v1.ListAuditRequest
	38, // 33: opsguard.v1.ManagementService.StreamLogs:input_type -> opsguard.v1.StreamLogsRequest
	40, // 34: opsguard.v1.ManagementService.SubscribeEvents:input_type -> opsguard.v1.SubscribeRequest
	40, // 35: opsguard.v1.ManagementService.SubscribeAudit:input_type -> opsguard.v1.SubscribeRequest
	43, // 36: opsguard.v1.ManagementService.Tunnel:input_type -> opsguard.v1.TunnelFrame
	1,  // 37: opsguard.v1.ManagementService.Ping:output_type -> opsguard.v1.Pong
	2,  // 38: opsguard.v1.ManagementService.Self:output_type -> opsguard.v1.SelfInfo
	4,  // 39: opsguard.v1.ManagementService.ListServices:output_type -> opsguard.v1.ListServicesResponse
	6,  // 40: opsguard.v1.ManagementService.GetService:output_type -> opsguard.v1.ServiceDetail
	13, // 41: opsguard.v1.ManagementService.Deploy:output_type -> opsguard.v1.Operation
	13, // 42: opsguard.v1.ManagementService.Update:output_type -> opsguard.v1.Operation
	13, // 43: opsguard.v1.ManagementService.Scale:output_type -> opsguard.v1.Operation
	13, // 44: opsguard.v1.ManagementService.Restart:output_type -> opsguard.v1.Operation
	13, // 45: opsguard.v1.ManagementService.Remove:output_type -> opsguard.v1.Operation
	13, // 46: opsguard.v1.ManagementService.GetOperation:output_type -> opsguard.v1.Operation
	14, // 47: opsguard.v1.ManagementService.ListNodes:output_type -> opsguard.v1.ListNodesResponse
	16, // 48: opsguard.v1.ManagementService.NodeStats:output_type -> opsguard.v1.NodeStatsResponse
	24, // 49: opsguard.v1.ManagementService.NodeProcesses:output_type -> opsguard.v1.ProcessesResponse
	20, // 50: opsguard.v1.ManagementService.NodeContainers:output_type -> opsguard.v1.NodeContainersResponse
	23, // 51: opsguard.v1.ManagementService.RestartContainer:output_type -> opsguard.v1.ContainerActionResult
	27, // 52: opsguard.v1.ManagementService.CheckPort:output_type -> opsguard.v1.PortCheckResult
	29, // 53: opsguard.v1.ManagementService.CheckHTTP:output_type -> opsguard.v1.HTTPCheckResult
	32, // 54: opsguard.v1.ManagementService.CheckFlow:output_type -> opsguard.v1.FlowCheckResult
	35, // 55: opsguard.v1.ManagementService.ListEvents:output_type -> opsguard.v1.ListEventsResponse
	37, // 56: opsguard.v1.ManagementService.ListAudit:output_type -> opsguard.v1.ListAuditResponse
	39, // 57: opsguard.v1.ManagementService.StreamLogs:output_type -> opsguard.v1.LogLine
	41, // 58: opsguard.v1.ManagementService.SubscribeEvents:output_type -> opsguard.v1.MonitorEvent
	42, // 59: opsguard.v1.ManagementService.SubscribeAudit:output_type -> opsguard.v1.AuditEntry
	43, // 60: opsguard.v1.ManagementService.Tunnel:output_type -> opsguard.v1.TunnelFrame
