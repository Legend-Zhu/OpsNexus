...
type WatchNodeStatsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *WatchNodeStatsRequest) Reset() {
	*x = WatchNodeStatsRequest{}
	mi := &file_opsguard_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *WatchNodeStatsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WatchNodeStatsRequest) ProtoMessage() {}

func (x *WatchNodeStatsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_opsguard_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WatchNodeStatsRequest.ProtoReflect.Descriptor instead.
func (*WatchNodeStatsRequest) Descriptor() ([]byte, []int) {
	return file_opsguard_proto_rawDescGZIP(), []int{16}
}

// NodeStatsUpdate carries either the base node list (kind="init", emitted
// first so the UI renders immediately) or one node's stats (kind="node",
// emitted per-node as each stats fetch completes — slow nodes don't block
// others). kind="init": nodes holds the base list (stats fields empty).
// kind="node": node_id identifies the node; the stat fields carry its sample.
type NodeStatsUpdate struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Kind           string                 `protobuf:"bytes,1,opt,name=kind,proto3" json:"kind,omitempty"`                   // "init" | "node"
	Nodes          []*Node                `protobuf:"bytes,2,rep,name=nodes,proto3" json:"nodes,omitempty"`                 // kind=init: base node list (stats fields empty)
	NodeId         string                 `protobuf:"bytes,3,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"` // kind=node: which node this sample is for
...
func (x *NodeStatsUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NodeStatsUpdate) ProtoMessage() {}

func (x *NodeStatsUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_opsguard_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NodeStatsUpdate.ProtoReflect.Descriptor instead.
func (*NodeStatsUpdate) Descriptor() ([]byte, []int) {
	return file_opsguard_proto_rawDescGZIP(), []int{17}
}

func (x *NodeStatsUpdate) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *NodeStatsUpdate) GetNodes() []*Node {
	if x != nil {
		return x.Nodes
	}
	return nil
...
func (x *NodeStatsUpdate) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *NodeStatsUpdate) GetReachable() bool {
	if x != nil {
		return x.Reachable
	}
	return false
...
func (x *NodeStatsUpdate) GetCpuPercent() float64 {
	if x != nil {
		return x.CpuPercent
	}
	return 0
...
func (x *NodeStatsUpdate) GetMemPercent() float64 {
	if x != nil {
		return x.MemPercent
	}
	return 0
...
func (x *NodeStatsUpdate) GetMemUsage() uint64 {
	if x != nil {
		return x.MemUsage
	}
	return 0
...
func (x *NodeStatsUpdate) GetMemLimit() uint64 {
	if x != nil {
		return x.MemLimit
	}
	return 0
...
func (x *NodeStatsUpdate) GetContainerCount() int32 {
	if x != nil {
		return x.ContainerCount
	}
	return 0
...
// ContainerAction targets one container on a node (node_id resolved by ID or
// hostname, same semantics as NodeContainersRequest.node_id).
type ContainerActionRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NodeId        string                 `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
	Container     string                 `protobuf:"bytes,2,opt,name=container,proto3" json:"container,omitempty"` // container name or ID
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ContainerActionRequest) GetNodeId() string {
	if x != nil {
		return x.NodeId
	}
	return ""
...
func (x *ContainerActionRequest) GetContainer() string {
	if x != nil {
		return x.Container
	}
	return ""
...
type ContainerActionResult struct {
	...
	Message       string                 `protobuf:"bytes,4,opt,name=message,proto3" json:"message,omitempty"` // error detail when !ok
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ContainerActionResult) GetNode() string {
	if x != nil {
		return x.Node
	}
	return ""
...
func (x *ContainerActionResult) GetContainer() string {
	if x != nil {
		return x.Container
	}
	return ""
...
func (x *ContainerActionResult) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
func (x *ContainerActionResult) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type ListEventsRequest struct {
	...
	Type    string                 `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`
	Limit   int32                  `protobuf:"varint,3,opt,name=limit,proto3" json:"limit,omitempty"`
	// 倒序分页游标：返回 seq < after_seq 的下一页（0 = 最新一页）。
...
func (x *MonitorEvent) Reset() {
	*x = MonitorEvent{}
	mi := &file_opsguard_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MonitorEvent) Descriptor() ([]byte, []int) {
	return file_opsguard_proto_rawDescGZIP(), []int{43}
}
...
func (x *AuditEntry) Reset() {
	*x = AuditEntry{}
	mi := &file_opsguard_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type TunnelFrame struct {
	...
	// chunked streaming (image relay over the tunnel): a response whose body
	// fits in one frame is sent as a single frame with chunk_eof=true;
	// larger bodies are split into frames with chunk_seq 0..N-1, the last one
	// carrying chunk_eof=true. Old peers that never set these fields are
	// single-frame responses (chunk_seq=0, chunk_eof=false).
	ChunkSeq int32 `protobuf:"varint,8,opt,name=chunk_seq,json=chunkSeq,proto3" json:"chunk_seq,omitempty"` // 0 = first (or only) response frame
	ChunkEof bool  `protobuf:"varint,9,opt,name=chunk_eof,json=chunkEof,proto3" json:"chunk_eof,omitempty"` // true = no more frames follow for this id
	// Request direction (Worker → server): req_chunked=true means the request
	// body is streamed over multiple frames (chunk_seq/chunk_eof describe the
	// request frames: first frame carries method/path/headers + first body
	// chunk, later frames carry only body, last one has chunk_eof=true).
	// req_chunked=false (or absent — old workers) is a complete single-frame
	// request whose body is the whole body.
...
func (x *TunnelFrame) Reset() {
	*x = TunnelFrame{}
	mi := &file_opsguard_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TunnelFrame) Descriptor() ([]byte, []int) {
	return file_opsguard_proto_rawDescGZIP(), []int{45}
}
...
func (x *TunnelHeader) Reset() {
	*x = TunnelHeader{}
	mi := &file_opsguard_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TunnelHeader) Descriptor() ([]byte, []int) {
	return file_opsguard_proto_rawDescGZIP(), []int{46}
}
...
const file_opsguard_proto_rawDesc = "" +
	...
	"memPercent\x12'\n" +
	"\x0fcontainer_count\x18\x0e \x01(\x05R\x0econtainerCount\"\x17\n" +
	"\x15WatchNodeStatsRequest\"\xaa\x02\n" +
	"\x0fNodeStatsUpdate\x12\x12\n" +
	"\x04kind\x18\x01 \x01(\tR\x04kind\x12'\n" +
	"\x05nodes\x18\x02 \x03(\v2\x11.opsguard.v1.NodeR\x05nodes\x12\x17\n" +
	...
	"memPercent\x12\x1b\n" +
	"\tmem_usage\x18\a \x01(\x04R\bmemUsage\x12\x1b\n" +
	"\tmem_limit\x18\b \x01(\x04R\bmemLimit\x12'\n" +
	"\x0fcontainer_count\x18\t \x01(\x05R\x0econtainerCount\"\xa7\x02\n" +
	...
	"\tchunk_seq\x18\b \x01(\x05R\bchunkSeq\x12\x1b\n" +
	"\tchunk_eof\x18\t \x01(\bR\bchunkEof\x12\x1f\n" +
	"\vreq_chunked\x18\n" +
	" \x01(\bR\n" +
	"reqChunked\"6\n" +
	"\fTunnelHeader\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value2\x98\x0e\n" +
	...
	"\tNodeStats\x12\x12.opsguard.v1.Empty\x1a\x1e.opsguard.v1.NodeStatsResponse\x12T\n" +
	"\x0eWatchNodeStats\x12\".opsguard.v1.WatchNodeStatsRequest\x1a\x1c.opsguard.v1.NodeStatsUpdate0\x01\x12R\n" +
...
var file_opsguard_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_opsguard_proto_goTypes = []any{
	...
	(*WatchNodeStatsRequest)(nil),  // 16: opsguard.v1.WatchNodeStatsRequest
	(*NodeStatsUpdate)(nil),        // 17: opsguard.v1.NodeStatsUpdate
	(*NodeStatsResponse)(nil),      // 18: opsguard.v1.NodeStatsResponse
	(*ContainerStat)(nil),          // 19: opsguard.v1.ContainerStat
	(*NodeProcessesRequest)(nil),   // 20: opsguard.v1.NodeProcessesRequest
	(*NodeContainersRequest)(nil),  // 21: opsguard.v1.NodeContainersRequest
	(*NodeContainersResponse)(nil), // 22: opsguard.v1.NodeContainersResponse
	(*ContainerInfo)(nil),          // 23: opsguard.v1.ContainerInfo
	(*ContainerActionRequest)(nil), // 24: opsguard.v1.ContainerActionRequest
	(*ContainerActionResult)(nil),  // 25: opsguard.v1.ContainerActionResult
	(*ProcessesResponse)(nil),      // 26: opsguard.v1.ProcessesResponse
	(*ProcessInfo)(nil),            // 27: opsguard.v1.ProcessInfo
	(*CheckPortRequest)(nil),       // 28: opsguard.v1.CheckPortRequest
	(*PortCheckResult)(nil),        // 29: opsguard.v1.PortCheckResult
	(*CheckHTTPRequest)(nil),       // 30: opsguard.v1.CheckHTTPRequest
	(*HTTPCheckResult)(nil),        // 31: opsguard.v1.HTTPCheckResult
	(*CheckFlowRequest)(nil),       // 32: opsguard.v1.CheckFlowRequest
	(*FlowStep)(nil),               // 33: opsguard.v1.FlowStep
	(*FlowCheckResult)(nil),        // 34: opsguard.v1.FlowCheckResult
	(*FlowStepResult)(nil),         // 35: opsguard.v1.FlowStepResult
	(*ListEventsRequest)(nil),      // 36: opsguard.v1.ListEventsRequest
	(*ListEventsResponse)(nil),     // 37: opsguard.v1.ListEventsResponse
	(*ListAuditRequest)(nil),       // 38: opsguard.v1.ListAuditRequest
	(*ListAuditResponse)(nil),      // 39: opsguard.v1.ListAuditResponse
	(*StreamLogsRequest)(nil),      // 40: opsguard.v1.StreamLogsRequest
	(*LogLine)(nil),                // 41: opsguard.v1.LogLine
	(*SubscribeRequest)(nil),       // 42: opsguard.v1.SubscribeRequest
	(*MonitorEvent)(nil),           // 43: opsguard.v1.MonitorEvent
	(*AuditEntry)(nil),             // 44: opsguard.v1.AuditEntry
	(*TunnelFrame)(nil),            // 45: opsguard.v1.TunnelFrame
	(*TunnelHeader)(nil),           // 46: opsguard.v1.TunnelHeader
	nil,                            // 47: opsguard.v1.CheckHTTPRequest.HeadersEntry
	nil,                            // 48: opsguard.v1.CheckFlowRequest.VarsEntry
	nil,                            // 49: opsguard.v1.FlowStep.HeadersEntry
	nil,                            // 50: opsguard.v1.FlowStep.ExtractEntry
	(*timestamppb.Timestamp)(nil),  // 51: google.protobuf.Timestamp
}
var file_opsguard_proto_depIdxs = []int32{
	15, // 0: opsguard.v1.ListNodesResponse.nodes:type_name -> opsguard.v1.Node
	15, // 1: opsguard.v1.NodeStatsUpdate.nodes:type_name -> opsguard.v1.Node
	19, // 2: opsguard.v1.NodeStatsResponse.containers:type_name -> opsguard.v1.ContainerStat
	23, // 3: opsguard.v1.NodeContainersResponse.containers:type_name -> opsguard.v1.ContainerInfo
	27, // 4: opsguard.v1.ProcessesResponse.processes:type_name -> opsguard.v1.ProcessInfo
	47, // 5: opsguard.v1.CheckHTTPRequest.headers:type_name -> opsguard.v1.CheckHTTPRequest.HeadersEntry
	33, // 6: opsguard.v1.CheckFlowRequest.steps:type_name -> opsguard.v1.FlowStep
	48, // 7: opsguard.v1.CheckFlowRequest.vars:type_name -> opsguard.v1.CheckFlowRequest.VarsEntry
	49, // 8: opsguard.v1.FlowStep.headers:type_name -> opsguard.v1.FlowStep.HeadersEntry
	50, // 9: opsguard.v1.FlowStep.extract:type_name -> opsguard.v1.FlowStep.ExtractEntry
	35, // 10: opsguard.v1.FlowCheckResult.steps:type_name -> opsguard.v1.FlowStepResult
	51, // 11: opsguard.v1.MonitorEvent.ts:type_name -> google.protobuf.Timestamp
	51, // 12: opsguard.v1.AuditEntry.ts:type_name -> google.protobuf.Timestamp
	46, // 13: opsguard.v1.TunnelFrame.headers:type_name -> opsguard.v1.TunnelHeader
	0,  // 14: opsguard.v1.ManagementService.Ping:input_type -> opsguard.v1.Empty
	0,  // 15: opsguard.v1.ManagementService.Self:input_type -> opsguard.v1.Empty
	3,  // 16: opsguard.v1.ManagementService.ListServices:input_type -> opsguard.v1.ListServicesRequest
	5,  // 17: opsguard.v1.ManagementService.GetService:input_type -> opsguard.v1.GetServiceRequest
	7,  // 18: opsguard.v1.ManagementService.Deploy:input_type -> opsguard.v1.DeployRequest
	8,  // 19: opsguard.v1.ManagementService.Update:input_type -> opsguard.v1.UpdateRequest
	9,  // 20: opsguard.v1.ManagementService.Scale:input_type -> opsguard.v1.ScaleRequest
	10, // 21: opsguard.v1.ManagementService.Restart:input_type -> opsguard.v1.RestartRequest
	11, // 22: opsguard.v1.ManagementService.Remove:input_type -> opsguard.v1.RemoveRequest
	12, // 23: opsguard.v1.ManagementService.GetOperation:input_type -> opsguard.v1.GetOperationRequest
	0,  // 24: opsguard.v1.ManagementService.ListNodes:input_type -> opsguard.v1.Empty
	0,  // 25: opsguard.v1.ManagementService.NodeStats:input_type -> opsguard.v1.Empty
	16, // 26: opsguard.v1.ManagementService.WatchNodeStats:input_type -> opsguard.v1.WatchNodeStatsRequest
	20, // 27: opsguard.v1.ManagementService.NodeProcesses:input_type -> opsguard.v1.NodeProcessesRequest
	21, // 28: opsguard.v1.ManagementService.NodeContainers:input_type -> opsguard.v1.NodeContainersRequest
	24, // 29: opsguard.v1.ManagementService.RestartContainer:input_type -> opsguard.v1.ContainerActionRequest
	28, // 30: opsguard.v1.ManagementService.CheckPort:input_type -> opsguard.v1.CheckPortRequest
	30, // 31: opsguard.v1.ManagementService.CheckHTTP:input_type -> opsguard.v1.CheckHTTPRequest
	32, // 32: opsguard.v1.ManagementService.CheckFlow:input_type -> opsguard.v1.CheckFlowRequest
	36, // 33: opsguard.v1.ManagementService.ListEvents:input_type -> opsguard.v1.ListEventsRequest
	38, // 34: opsguard.v1.ManagementService.ListAudit:input_type -> opsguard.v1.ListAuditRequest
	40, // 35: opsguard.v1.ManagementService.StreamLogs:input_type -> opsguard.v1.StreamLogsRequest
	42, // 36: opsguard.v1.ManagementService.SubscribeEvents:input_type -> opsguard.v1.SubscribeRequest
	42, // 37: opsguard.v1.ManagementService.SubscribeAudit:input_type -> opsguard.v1.SubscribeRequest
	45, // 38: opsguard.v1.ManagementService.Tunnel:input_type -> opsguard.v1.TunnelFrame
	1,  // 39: opsguard.v1.ManagementService.Ping:output_type -> opsguard.v1.Pong
	2,  // 40: opsguard.v1.ManagementService.Self:output_type -> opsguard.v1.SelfInfo
	4,  // 41: opsguard.v1.ManagementService.ListServices:output_type -> opsguard.v1.ListServicesResponse
	6,  // 42: opsguard.v1.ManagementService.GetService:output_type -> opsguard.v1.ServiceDetail
	13, // 43: opsguard.v1.ManagementService.Deploy:output_type -> opsguard.v1.Operation
	13, // 44: opsguard.v1.ManagementService.Update:output_type -> opsguard.v1.Operation
	13, // 45: opsguard.v1.ManagementService.Scale:output_type -> opsguard.v1.Operation
	13, // 46: opsguard.v1.ManagementService.Restart:output_type -> opsguard.v1.Operation
	13, // 47: opsguard.v1.ManagementService.Remove:output_type -> opsguard.v1.Operation
	13, // 48: opsguard.v1.ManagementService.GetOperation:output_type -> opsguard.v1.Operation
	14, // 49: opsguard.v1.ManagementService.ListNodes:output_type -> opsguard.v1.ListNodesResponse
	18, // 50: opsguard.v1.ManagementService.NodeStats:output_type -> opsguard.v1.NodeStatsResponse
	17, // 51: opsguard.v1.ManagementService.WatchNodeStats:output_type -> opsguard.v1.NodeStatsUpdate
	26, // 52: opsguard.v1.ManagementService.NodeProcesses:output_type -> opsguard.v1.ProcessesResponse
	22, // 53: opsguard.v1.ManagementService.NodeContainers:output_type -> opsguard.v1.NodeContainersResponse
	25, // 54: opsguard.v1.ManagementService.RestartContainer:output_type -> opsguard.v1.ContainerActionResult
	29, // 55: opsguard.v1.ManagementService.CheckPort:output_type -> opsguard.v1.PortCheckResult
	31, // 56: opsguard.v1.ManagementService.CheckHTTP:output_type -> opsguard.v1.HTTPCheckResult
	34, // 57: opsguard.v1.ManagementService.CheckFlow:output_type -> opsguard.v1.FlowCheckResult
	37, // 58: opsguard.v1.ManagementService.ListEvents:output_type -> opsguard.v1.ListEventsResponse
	39, // 59: opsguard.v1.ManagementService.ListAudit:output_type -> opsguard.v1.ListAuditResponse
	41, // 60: opsguard.v1.ManagementService.StreamLogs:output_type -> opsguard.v1.LogLine
	43, // 61: opsguard.v1.ManagementService.SubscribeEvents:output_type -> opsguard.v1.MonitorEvent
	44, // 62: opsguard.v1.ManagementService.SubscribeAudit:output_type -> opsguard.v1.AuditEntry
	45, // 63: opsguard.v1.ManagementService.Tunnel:output_type -> opsguard.v1.TunnelFrame
